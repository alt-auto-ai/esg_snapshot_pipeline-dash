...
# CONFIG
# =========================
CSV_PATH = r"2_story_links.csv"
CSV_WITH_SELECTORS_PATH = r"3_story_links_with_selectors.csv"

OUTPUT_DIR = r"story_md_files"
FAIL_LOG = r"3_story_failures.csv"
INVALID_LOG = r"3_story_invalid_urls.csv"
NORMALIZED_MAP_LOG = r"3_story_normalized_map.csv"
SELECTOR_LOG = r"3_story_guessed_selectors.csv"

# NEW: output file mapping input rows to md filenames
STORY_FILENAME_LINKS = r"3_story_file_name_links.csv"  # NEW
...
# =========================
def read_urls_from_csv(csv_path: str) -> Tuple[List[str], List[Tuple[str, str]], List[Tuple[str, str]]]:
    """
    Returns (urls, invalids[(raw, reason)], normalized_map[(raw, normalized)]) based ONLY on the 'URL' column.
    """
    urls: List[str] = []
    ...
    return urls, invalids, normalized_map
...
async def extract_page(
    ...
    try:
        ...
        if result.success:
            save_markdown(OUTPUT_DIR, output_filename, result.markdown.raw_markdown)
...
# =========================
def write_augmented_csv_with_selectors(input_csv_path: str, output_csv_path: str, selectors_map: Dict[str, Optional[str]]):
    """
...
def write_story_filename_links(input_csv_path: str, output_csv_path: str, url_to_file: Dict[str, str]):
    ...
    with open(output_csv_path, "w", encoding="utf-8", newline="") as f_out:
        ...
        writer.writerow(["Date", "Title", "URL", "md_file"])
...
async def main():
    ...
    write_augmented_csv_with_selectors(CSV_PATH, CSV_WITH_SELECTORS_PATH, selectors)
    ...
    write_story_filename_links(CSV_PATH, STORY_FILENAME_LINKS, url_to_file)  # NEW
