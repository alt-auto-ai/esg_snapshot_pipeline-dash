...
SOURCE_DIR = os.getenv("SOURCE_DIR", r"9_events_md_files")
OUTPUT_CSV = os.getenv("OUTPUT_CSV", r"9.2_events_data.csv")
...
PROMPT_FILE = "9.2_extract_events_link_prompt.yaml"
...
end_date = today_local + timedelta(days=7)
