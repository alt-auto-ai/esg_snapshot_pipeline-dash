...
Print or Download
## On this page
  * [Family trust for tax purposes](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#ato-Familytrustfortaxpurposes)
  * [Family trust elections](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#ato-Familytrustelections)
  * [Interposed entity elections](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#ato-Interposedentityelections)
  * [Make, vary, or revoke an FTE or an IEE](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#ato-MakevaryorrevokeanFTEoranIEE)
  * [Family trust distribution tax](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#ato-Familytrustdistributiontax)
  * [General interest charge](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#ato-Generalinterestcharge)
  * [Terminology for family trusts](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#ato-Terminologyforfamilytrusts)
  * [Examples showing how FTDT applies](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#ato-ExamplesshowinghowFTDTapplies)


##  Family trust for tax purposes
A family trust for tax purposes is one whose trustee has made a voluntary election to be treated as a family trust for tax purposes. This is known as a [family trust election](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#FamilyTrustElections) (FTE). A trust is not a family trust for tax purposes simply because the words 'family trust' are in the trust's name. The trustee must take the active step of making an FTE for the trust to be treated as a family trust for tax purposes.
There are 5 main reasons why a trustee may choose to make an FTE:
  1. [Trust loss provisions](https://www.ato.gov.au/businesses-and-organisations/trusts/trust-income-losses-and-capital-gains/trust-loss-provisions/about-trust-loss-provisions) – a non-fixed trust has losses or deductions but may not be able to satisfy the trust loss tests to utilise them. By becoming a family trust, the trust is subject to concessional tax treatment. Only one of the trust loss tests (the income injection test) applies, and only in a modified way.
  ...
  3. [The holding period rules regulating access to franking credits](https://www.ato.gov.au/businesses-and-organisations/trusts/trust-income-losses-and-capital-gains/non-widely-held-trusts-and-the-franking-tax-offset) – a valid FTE in place may enable a beneficiary's interest in shares held by trust to be considered to be held 'at risk'. Both the beneficiary and trusts are required to hold the shares or interest in the shares 'at risk' for a continuous period of at least 45 days (or 90 days for preference shares) during the qualification period to access the franking credits.
  4. [Trustee beneficiary reporting](https://www.ato.gov.au/businesses-and-organisations/trusts/trusts-registration-and-reporting-obligations/closely-held-trusts/trustee-beneficiary-reporting-rules) **(TBR) rules** – trusts that have made an FTE or an [interposed entity election](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Interposedentityelections10) (IEE) (among others) are excluded from the TBR rules.
...
The FTE entitles the trust to access certain tax concessions. However, [family trust distribution tax](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Familycontroltest) (FTDT) is imposed at the top marginal rate of tax to distributions made outside the [family group](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Familygroup10). FTDT can have severe consequences, so it is critical that trustees understand the implications an FTE can have on the family trust, the broader private group and future generations before making an FTE.
##  Family trust elections
A trustee may make a family trust election (FTE) for a specified income year by making the election in writing and in the approved form. The trust must pass the [family control test](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Familycontroltest11) (FCT) at the end of the specified income year. The FTE must also specify an individual as the individual whose family group is taken into account for the election.
...
The income year specified in the FTE must have ended before the FTE is made. An FTE can only be made if the trust passes the FCT at the end of the specified income year. The FTE can specify an earlier income year to commence the election if from the beginning of the specified income year until 30 June of the income year immediately prior to the income year the election is made, both:
  ...
  * any conferrals of present entitlement or actual [distributions](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Distributions) of income or capital during the period have been made to 
...
Once the FTE has been made, it can only be [varied](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#FTEVariation) or [revoked](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#FTErevocation) in limited circumstances.
For more information about making an FTE, see [Family trust election, revocation or variation 2025](https://www.ato.gov.au/forms-and-instructions/family-trust-election-revocation-or-variation-2025-instructions/how-to-get-a-family-trust-election-revocation-or-variation-2025) (NAT 2787).
...
The specified individual can be varied once, but only once, subject to certain conditions, including that both:
  * the new specified individual was a member of the original specified individual's [family](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Familyofthespecifiedindividual) at the time the election commenced
  * there have been no conferrals of present entitlement or [distributions](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Distributions) of income or capital 
    * by the trustee of the family trust or an entity that made an [interposed entity election](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Interposedentityelections10) to interpose with the family trust election
    * to parties outside the new specified individual’s [family group](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Familygroup10)
...
An interposed entity election (IEE) is a voluntary election which allows a trust, partnership, or company to join the family group of an individual specified in a [family trust election](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#FamilyTrustElections) made by a trust. The 2 main reasons to make an IEE are to:
  * make an entity a member of the [family group](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Familygroup10) of the individual specified in an FTE, which means the trustee of the family trust can confer present entitlement to, or [distribute](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Distributions), income or capital on or to the entity that made the IEE without the trustee becoming liable for [family trust distribution tax](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Familycontroltest).
  * exclude a trust from having to comply with the [Trustee beneficiary reporting rules](https://www.ato.gov.au/businesses-and-organisations/trusts/trusts-registration-and-reporting-obligations/closely-held-trusts/trustee-beneficiary-reporting-rules).
...
The interposed entity can specify an earlier income year from when the election is to commence. This is if, from the beginning of the specified income year until 30 June of the income year immediately preceding the election, both:
  * the entity passes the [family control test](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Familycontroltest11)
  * any conferrals of present entitlement or actual [distributions](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Distributions) of income or capital of the family trust (the entity is interposing with) during the period have been made on or to: 
...
Once an IEE has been made, it can only be [revoked](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Revokinganinterposedentityelection) in very limited circumstances. An IEE can't be varied.
These rules apply to IEEs specifying the 2005 and later income years.
For more information, see [Interposed entity election or revocation 2025](https://www.ato.gov.au/forms-and-instructions/interposed-entity-election-or-revocation-2025-instructions) (NAT 2788).
...
For more information, see:
  * [Family trust election, revocation or variation 2025](https://www.ato.gov.au/forms-and-instructions/family-trust-election-revocation-or-variation-2025-instructions/how-to-get-a-family-trust-election-revocation-or-variation-2025) (NAT 2787).
  * [Interposed entity election or revocation 2025](https://www.ato.gov.au/forms-and-instructions/interposed-entity-election-or-revocation-2025-instructions/how-to-get-the-interposed-entity-election-or-revocation-2025) (NAT 2788).
...
For more information, see [PS LA 2005/2](https://www.ato.gov.au/law/view/document?DocID=PSR/PS20052/NAT/ATO/00001&PiT=99991231235958) _Penalty for failure to keep or retain records_.
##  Family trust distribution tax
Family trust distribution tax (FTDT) is a special tax that is payable where:
  * a trustee of a trust has made a [family trust election](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#FamilyTrustElections)
  * a partnership's partners, a company or the trustee of another trust have made an [interposed entity election](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Interposedentityelections10) to be included in the [family group](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Familygroup10) of the individual specified in the FTE made by the family trust
  * the trustee of the family trust, interposed trust, or interposed partnership or the interposed company 
    * confers a present entitlement to, or [distributes](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Distributions), income or capital
    * to an entity other than to the [specified individual](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#TheindividualspecifiedintheFTE) or members of the specified individual's [family group](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Familygroup10).
...
A person that is dissatisfied with a FTDT notice of liability may [object to a decision](https://www.ato.gov.au/individuals-and-families/your-tax-return/if-you-disagree-with-an-ato-decision/object-to-a-decision) to issue the notice. You can't object to the imposition of FTDT directly.
For more information, see our webinar recording on these rules – [Family trust elections – What you need to knowExternal Link](https://tv.ato.gov.au/media/bi9or7orckqt3o).
##  General interest charge
The person is also liable to pay the [general interest charge](https://www.ato.gov.au/individuals-and-families/paying-the-ato/interest-and-penalties/interest-we-charge/general-interest-charge) (GIC) on any unpaid amount of FTDT that remains unpaid 60 days after the day it is due to be paid. This applies for each day in the period that began 60 days after the FTDT was due. It finishes on the last day that the FTDT and applicable GIC remains unpaid.
...
GIC on FTDT is GIC imposed on an unpaid tax liability (that is, late payment GIC). Taxpayers can request remission of GIC on a case-by-case basis under section 8AAG of the _Taxation Administration Act_  _1953_ and in accordance with [PS LA 2011/12](https://www.ato.gov.au/law/view/document?DocID=PSR/PS201112/NAT/ATO/00001&PiT=99991231235958) _Remission of General Interest Charge_.
Where an electing entity has taken reasonable steps to mitigate the effects of those circumstances, up to 31 December 2026, we may consider it fair and reasonable to remit GIC:
  * 80% remission down to 20% of GIC liability remaining – where a taxpayer has: 
    ...
    * lodged the [Family trust distribution tax payment advice form](https://www.ato.gov.au/forms-and-instructions/family-trust-distribution-tax-payment-advice) (NAT 6175)
    * paid the FTDT
...
For more information, see:
  * [Remission of interest charges](https://www.ato.gov.au/individuals-and-families/your-tax-return/if-you-disagree-with-an-ato-decision/dispute-interest-or-penalties/remission-of-interest-charges).
  ...
  * [Spotlight on… Assistant Commissioner Amy-James Velagic](https://www.ato.gov.au/businesses-and-organisations/business-bulletins-newsroom/spotlight-on-assistant-commissioner-amy-james-velagic).


### If you identify that FTDT is payable
If you identify that FTDT is payable on a distribution, you should pay the FTDT as soon as possible to prevent further GIC accruing. Accompany each payment of FTDT with the [Family trust distribution tax payment advice](https://www.ato.gov.au/forms-and-instructions/family-trust-distribution-tax-payment-advice) (NAT 6175).
Upon payment of the FTDT, the amount or value of the distribution may become non-assessable non-exempt income of the trust, partnership or company, or any other person. The trustee, entity or other person may request an amendment to their assessment at any time to reflect these amounts. For more information, see [Amend your tax return](https://www.ato.gov.au/individuals-and-families/your-tax-return/amend-your-tax-return).
...
Once you have made an FTE or an IEE, it’s important to be mindful of who the [specified individual](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#TheindividualspecifiedintheFTE) is (for each election). There is a strict legal definition of [family](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Familyofthespecifiedindividual) and [family group](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Familygroup10), based on who the members of the 'specified individual’s' family group are.
...
Before you make conferrals or [distributions](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Distributions), you should:
...
Refer to [Examples showing how FTDT applies](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#ExamplesshowinghowFTDTapplies).
...
#### Trusts
When making a [family trust election](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#FamilyTrustElections) (FTE) or an [interposed entity election](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Interposedentityelections10) (IEE), a trust passes the FCT at a point in time when some or all of the following people control the trust:
  * the individual specified in the relevant FTE
  * members of the specified individual's [family](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Familygroup10)
...
A company or partnership passes the FCT when the [specified individual](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#TheindividualspecifiedintheFTE), members of their family and family trusts that have made an FTE in favour of the specified individual, beneficially hold between them, directly or indirectly, fixed entitlements to more than 50% of the income or capital of the company or partnership.
...
###  Family group
When determining whether a conferral or distribution has been made, the following people and entities are generally members of the family group of the [individual specified](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#TheindividualspecifiedintheFTE) in the FTE:
...
There is only very limited scope for a company or partnership to be a member of the specified individual's family group, without an IEE to that effect. A company or partnership that is partly or fully owned by persons or entities that are not the specified individual, members of the specified individual's family and family trusts will not generally be part of the specified individual's family group. Shareholders in a company with share classes carrying discretionary rights to income or capital may not have fixed entitlements to all of the income and capital of the company. There are also strict rules for [companies and partnerships](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Companiesandpartnerships) to satisfy the [family control test](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#Familycontroltest11) to make an IEE, which may mean it is not possible for a company or partnership to elect into the specified individual's family group.
...
The family of the individual specified in the relevant FTE consists of that person (the test individual) and all of the following (if applicable):
  1. Any parent, grandparent, brother, or sister of the [specified individual](https://www.ato.gov.au/businesses-and-organisations/trusts/family-trusts#TheindividualspecifiedintheFTE) or the specified individual's spouse.
...
![This diagram shows the ‘family’ that applied from 1 July 2007 as defined in section 272-95 of the Income Tax Assessment Act 1936, as described above under the heading titled Family of the specified individual.](https://www.ato.gov.au/api/public/content/8e2377a3-f49a-4564-85ca-b4337dc43480_48752_PGH_flowchart_gif)
###  Distributions
...
### Example 1: fixed trust distributions
...
End of example
### Example 3: corporate beneficiaries
...
End of example
### Example 5: death of specified individual
