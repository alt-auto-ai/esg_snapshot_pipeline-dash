...
![Nature Strategy Accelerator driving insights from environmental data](https://www.wbcsd.org/wp-content/uploads/2026/03/Unlocking-value-from-nature-data-with-Nature-Strategy-Accelerator-1.webp)
Published 
10 March, 2026 
Type 
WBCSD insights 
...
Furthermore, WBCSD’s recent review of the link of a company’s [sustainability performance and corporate valuation](https://www.wbcsd.org/resources/sustainability-and-company-value/) clearly demonstrates: **strategic, credible disclosure is directly linked to tangible financial and reputational outcomes.**
...
Nature has a marketing problem. The term “nature” is regularly used inter-changeably with “biodiversity” and is still seen as “just pandas and whales”. Companies are focusing on impacts and 
  ...
  * WBCSD has a [whole program on capability building](https://www.wbcsd.org/news/building-business-capacity-on-nature/) for nature targeted to different maturity levels. The Nature Foundations: Masterclass series helps build a common understanding on the importance of addressing nature loss for business continuity and how. The Accelerator then enables companies to transform their nature assessments into a narrative and a strategic approach that resonates far more strongly with strategy, procurement, and finance functions. 
...
Companies also wrestled with how site- and landscape-level actions meaningfully aggregate to national or global organizational targets, and how to meaningfully support implementation of the Global Biodiversity Framework and national biodiversity strategy and action plans (NBSAPs). Challenges included balancing global with local decision-making, differing levels of granularity and standardizing metrics and methodologies. 
  ...
  * Companies repeatedly highlighted that inconsistent or missing site‑level metrics made it difficult to track progress and benchmark performance. WBCSD’s [Nature Action Portal](https://www.wbcsd.org/nature-action-portal/) serves as an accessible entry point for selecting harmonized metrics that support both local decision‑making and global reporting (see forthcoming primer later in 2026). 
...
Many companies noted that climate continues to command disproportionate attention. Rather than competing, several Accelerator participants used this to their advantage, integrating nature through nature-based solutions, climate adaptation or integrated transition planning.
  * This aligns with WBCSD’s recent guidance to [integrated transition planning](https://www.wbcsd.org/resources/integrated-transition-planning-a-short-introduction/), which points toward single, integrated assessments rather than multiple parallel processes—reducing burden while improving strategic coherence. 
...
To support this, we are integrating the latest guidance from **TNFD’s**[WBCSD’s Introduction to **Integrated Transition Planning**](https://www.wbcsd.org/resources/integrated-transition-planning-a-short-introduction/) into the Accelerator curriculum. This offers a single, streamlined approach to helping members move from high‑level commitments to practical, implementable transition plans. By aligning with leading global frameworks, companies gain greater confidence that their actions are credible, comparable, and positioned to meet rising investor, regulatory, and stakeholder expectations. 
...
If you would like to learn more about joining WBCSD’s Nature Action Imperative, please contact **[Nature Action](https://www.wbcsd.org/actions/nature-action/ "Nature Action") **webpage.
* * *
## Related   
Topics
  * [ Roadmaps to Nature Positive ](https://www.wbcsd.org/tags?tag=Roadmaps+to+Nature+Positive)
  * [ Nature Action ](https://www.wbcsd.org/tags?tag=Nature+Action)
...
Outline
[ **Why read this article?** ](https://www.wbcsd.org/news/what-the-nature-strategy-accelerator-unlocks-turning-nature-data-into-strategic-advantage/#why-read-this-article)
[ **Challenge #1: Making the business case… again** ](https://www.wbcsd.org/news/what-the-nature-strategy-accelerator-unlocks-turning-nature-data-into-strategic-advantage/#challenge-1-making-the-business-case-again)
[   
**Challenge #2: Structuring data, metrics and targets to inform decisions** ](https://www.wbcsd.org/news/what-the-nature-strategy-accelerator-unlocks-turning-nature-data-into-strategic-advantage/#challenge-2-structuring-data-metrics-and-targets-to-inform-decisions)
[   
**Challenge #3: Navigating corporate realities of setting strategy** ](https://www.wbcsd.org/news/what-the-nature-strategy-accelerator-unlocks-turning-nature-data-into-strategic-advantage/#challenge-3-navigating-corporate-realities-of-setting-strategy)
[ **What the Nature Strategy Accelerator unlocks** ](https://www.wbcsd.org/news/what-the-nature-strategy-accelerator-unlocks-turning-nature-data-into-strategic-advantage/#what-the-nature-strategy-accelerator-unlocks)
[ **What’s next** ](https://www.wbcsd.org/news/what-the-nature-strategy-accelerator-unlocks-turning-nature-data-into-strategic-advantage/#whats-next)
##  Related   
Content
[ General  WBCSD launches the Nature Action Portal to drive business action and accountability on nature  26 November, 2025  ](https://www.wbcsd.org/news/wbcsd-launches-the-nature-action-portal-to-drive-business-action-and-accountability-on-nature/) [ General  The Natural Climate Solutions Alliance’s COP30 Policy Asks  5 November, 2025  ](https://www.wbcsd.org/news/the-natural-climate-solutions-alliances-cop30-policy-asks/) [ General  Driving business accountability for nature action along the value chain  19 September, 2025  ](https://www.wbcsd.org/news/driving-business-accountability-for-nature-action-along-the-value-chain/)
