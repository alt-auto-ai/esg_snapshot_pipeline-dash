...
On 27 May 2026 the ACCC issued a draft determination proposing to grant authorisation to IAG Cargo Limited (IAGC), MAB Kargo Sdn. Bhd (MABK) and Qatar Airways Group Q.S.S.C (Qatar Airways) to cooperate on and coordinate their air cargo services. The application for authorisation relates to air cargo services, including to and from Australia.
The ACCC proposes to grant authorisation for a period of 5 years.
The ACCC has also granted interim authorisation to IAGC, MABK and Qatar Airways so the conduct can start while the ACCC continues its assessment of the application.
The ACCC is now seeking submissions in response to the draft determination by **Tuesday, 10 June 2026** , before making its final decision.
Further details about the application and how to make a submission are available on the ACCC’s public register at: [IAG Cargo Limited & Ors](https://www.accc.gov.au/public-registers/authorisations-and-notifications-registers/authorisations-register/iag-cargo-limited-ors)
