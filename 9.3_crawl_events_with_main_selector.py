...
# CONFIG
# =========================
CSV_PATH = r"9.2_events_data.csv"
CSV_WITH_SELECTORS_PATH = r"9.3_events_links_with_selectors.csv"

OUTPUT_DIR = r"9.2_events_page_mds"
FAIL_LOG = r"9.3_events_failures.csv"
INVALID_LOG = r"9.3_events_invalid_urls.csv"
NORMALIZED_MAP_LOG = r"9.3_events_normalized_map.csv"
SELECTOR_LOG = r"9.3_events_guessed_selectors.csv"

# NEW: output file mapping input rows to md filenames
STORY_FILENAME_LINKS = r"9.3_events_links.csv"  # NEW
