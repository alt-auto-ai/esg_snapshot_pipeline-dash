...
CSV_PATH = str(SCRIPT_DIR / "9.2_events_data.csv")
CSV_WITH_SELECTORS_PATH = str(SCRIPT_DIR / "9.3_events_links_with_selectors.csv")

OUTPUT_DIR = str(SCRIPT_DIR / "9.2_events_page_mds")
FAIL_LOG = str(SCRIPT_DIR / "9.3_events_failures.csv")
INVALID_LOG = str(SCRIPT_DIR / "9.3_events_invalid_urls.csv")
NORMALIZED_MAP_LOG = str(SCRIPT_DIR / "9.3_events_normalized_map.csv")
SELECTOR_LOG = str(SCRIPT_DIR / "9.3_events_guessed_selectors.csv")

# NEW: output file mapping input rows to md filenames
STORY_FILENAME_LINKS = str(SCRIPT_DIR / "9.3_events_links.csv")  # NEW
