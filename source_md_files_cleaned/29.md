Story's url: https://www.imo.org/en/MediaCentre/PressBriefings/pages/IMO-progresses-work-on-ship-emissions-pollution-and-ocean-protection.aspx
...
The Committee advanced its work on underwater radiated noise ([URN]( agreeing in principle to extend the experience-building phase (EBP) by two years, to the end of 2028. The EBP aims to address barriers Member States face in applying IMO’s Revised guidelines for the reduction of underwater radiated noise from shipping to address adverse impacts on marine life ([MEPC.1/Circ.906/Rev.1](
